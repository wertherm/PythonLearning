#Até o Python 2.7 para que o conjunto de módulos em um diretório fosse considerado um pacote Python, era necessário que um arquivo __init__.py estivesse no diretório com os demais módulos.
...
#A partir do Python 3.3 não é mais necessário utilizar o __init.__.py para esta finalidade. Devido a um mecanismo denominado “Namespace packages”, o pacote é identificado automaticamente.
